...
def user_not_found(update, _):
    ...
    update.message.reply_text(
        ...
        "\nЧтобы получить доступ к проектам, зарегестрируйтесь через веб-приложение: " + settings.REF_TO_SERVER + "."
        "\nИспользуя персональный токен: " + str(new_user.personal_token) + "."
