...
urlpatterns += [re_path(r'^projects/create$',  user_passes_test(User.is_verified)(views.ProjectCreate.as_view()), name = "project-create")]
urlpatterns += [re_path(r'^project/(?P<pk>\d+)/change/$',  user_passes_test(User.is_verified)(views.ProjectUpdate.as_view()), name = "project-change")]
